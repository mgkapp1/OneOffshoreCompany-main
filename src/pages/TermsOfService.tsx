    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl opacity-90">Terms and conditions for using our services</p>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg max-w-none">
          <h2>Terms and Conditions</h2>
          <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Emford Global DMCC trading as One Offshore Company's relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.</p>
          <p>The term 'Emford Global DMCC trading as One Offshore Company' or 'us' or 'we' refers to the owner of the website whose registered office is Unit no 903, Fortune Executive Tower, Plot no T1, Jumeirah Lakes Towers, Dubai, UAE. The term 'you' refers to the user or viewer of our website.</p>
          
          {/* Rest of the Terms of Service content remains the same */}
