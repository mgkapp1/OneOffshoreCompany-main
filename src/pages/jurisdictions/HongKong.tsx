          ...
          <div className="space-y-6">
            <div className="rounded-lg border bg-white shadow-sm">
              ...
              <div className="p-6 pt-0">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Annual renewal: £899</p>
                </div>
                <button 
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li>• Gateway to China and Asian markets</li>
                <li>• No restrictions on foreign ownership</li>
                <li>• Simple and efficient company registration</li>
                <li>• No capital controls or currency restrictions</li>
                <li>• Professional and multilingual workforce</li>
