      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">UK LTD Company Formation</h1>
              <p className="text-gray-600">Private Limited Company registration in the United Kingdom</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">About UK LTD</h2>
              <p className="text-gray-600 mb-4">
                A UK Limited Company (LTD) is the most popular business structure in the United Kingdom, 
                offering limited liability protection, tax efficiency, and credibility for businesses 
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tax efficient structure</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Access to UK banking</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="rounded-lg border bg-white shadow-sm">
              ...
              <div className="p-6 pt-0">
                <div className="text-center mb-6">
                  <div className="text-3xl font-bold text-[#3FA4F4] mb-2">£300.00</div>
                  <p className="text-gray-600">Formation Package</p>
                  <p className="text-sm text-gray-500 mt-2">Annual renewal: £250</p>
                </div>
                <button 
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Why Choose UK LTD?</h3>
              <ul className="space-y-3 text-gray-600">
                <li>• Limited liability protection for shareholders</li>
                <li>• Tax advantages and dividend planning</li>
                <li>• Professional business credibility</li>
                <li>• Access to UK banking and financial services</li>
                <li>• Simple and efficient company registration</li>
                <li>• Worldwide recognition of UK companies</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• Minimum 1 director (can be non-UK resident)</li>
                <li>• Minimum 1 shareholder (can be the same as director)</li>
                <li>• UK registered office address</li>
                <li>• Company secretary (optional)</li>
                <li>• Minimum share capital: £1</li>
              </ul>
            </div>
          </div>
        </div>
